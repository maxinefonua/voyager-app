      ...
      builder: (context) {
        return StatefulBuilder(
          builder: (context, setState) {
            ...
            // Scroll to selected airline after the bottom sheet is built
            WidgetsBinding.instance.addPostFrameCallback((_) {
              if (selectedAirline != null &&
                  airlineKeys.containsKey(selectedAirline)) {
                ...
                children: [
                  ...
                  Expanded(
                    child: filteredAirlines.isEmpty
                        ...
                        : ListView(
                            shrinkWrap: true,
                            children: filteredAirlines.map((airline) {
                              final isEnabled =
                                  enabledAirlines?.contains(airline) ?? true;
                              final key = GlobalKey();
                              airlineKeys[airline] = key;
                              ...
                              return ListTile(
                                ...
                                trailing: selectedAirline == airline
                                    ? Icon(Icons.check, color: Colors.blue)
                                    : null,
                                onTap: isEnabled
                                    ? () {
                  ...
                  // Single close button instead of Cancel/Confirm
                  Padding(
